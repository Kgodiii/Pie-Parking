...
if(isset($_POST["loginSubmit"])){
    ...
    if($success){
        ...
        $error = "<span class='errorMessage'>Incorrect Login Information</span>";
    }
}
    ...
    <body>
        <div class="center">
            <div class="card">
                <h1>Login</h1>
                <form method="post">
                    <?php echo $account->getError(Errors::$usernameLength); ?>
                    <?php echo $account->getError(Errors::$usernameCharacters); ?>
